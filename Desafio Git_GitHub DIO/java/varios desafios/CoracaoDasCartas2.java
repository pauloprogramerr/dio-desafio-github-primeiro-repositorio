...
public class CoracaoDasCartas2 {
    ...
    public static boolean cartas(int a, int b, int c) {
        ...
        if (a < n && b < n && (pilha[0][a]+pilha[1][b]) % 3 == 0
                && cartas(a + 1, b + 1, c)) {
            m.putIfAbsent(ss, 1);
            return true;
        }

        if (a < n && c < n && (pilha[0][a]+pilha[2][c]) % 3 == 0
                && cartas(a + 1, b, c + 1)) {
            m.putIfAbsent(ss, 1);
            return true;
        }

        if (b < n && c < n && (pilha[1][b]+pilha[2][c])%3 == 0
                && cartas(a, b + 1, c + 1)) {
            m.putIfAbsent(ss, 1);
            return true;
        }
        ...
        if (a < n && b < n && c < n
                && (pilha[0][a]+pilha[1][b]+pilha[2][c]) % 3 == 0
                && cartas(a + 1, b + 1, c + 1)) {
